 ...
 *******************************************************************************/
package org.mondo.generate.modular.project.main;
...
/**
 * Entry point of the 'WorkFlowModularProject' generation module.
 *
 * @generated
 */
public class WorkFlowModularProject extends AbstractAcceleoGenerator {
    /**
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "WorkFlowModularProject" };
     ...
     * @generated
     */
    public WorkFlowModularProject(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public WorkFlowModularProject(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                WorkFlowModularProject generator = new WorkFlowModularProject(modelURI, folder, arguments);
    ...
    public List<String> getProperties() {
    	...
    	propertiesFiles.add("/org/mondo/generate/modular/project/properties/default_plugin_features.properties");
