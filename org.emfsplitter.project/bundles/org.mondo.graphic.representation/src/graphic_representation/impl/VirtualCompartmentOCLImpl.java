...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Virtual Compartment OCL</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link graphic_representation.impl.VirtualCompartmentOCLImpl#getOclExpression <em>Ocl Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VirtualCompartmentOCLImpl extends VirtualCompartmentImpl implements VirtualCompartmentOCL {
	/**
	 ...
	 * @generated
	 */
	protected VirtualCompartmentOCLImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Graphic_representationPackage.Literals.VIRTUAL_COMPARTMENT_OCL;
	}
	...
	public void setOclExpression(String newOclExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Graphic_representationPackage.VIRTUAL_COMPARTMENT_OCL__OCL_EXPRESSION, oldOclExpression, oclExpression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Graphic_representationPackage.VIRTUAL_COMPARTMENT_OCL__OCL_EXPRESSION:
