 ...
 *******************************************************************************/
package org.mondo.generate.modular.project.general.create.project.main;
...
/**
 * Entry point of the 'GeneralModularProject' generation module.
 *
 * @generated
 */
public class GeneralModularProject extends AbstractAcceleoGenerator {
    /**
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generalModularProject" };
     ...
     * @generated
     */
    public GeneralModularProject(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GeneralModularProject(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GeneralModularProject generator = new GeneralModularProject(modelURI, folder, arguments);
    ...
    public List<String> getProperties() {
    	...
    	propertiesFiles.add("/org/mondo/generate/modular/project/general/create/project/properties/defaultFeatures.properties");
