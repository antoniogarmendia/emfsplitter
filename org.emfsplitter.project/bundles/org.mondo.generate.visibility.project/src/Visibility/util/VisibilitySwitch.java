...
public class VisibilitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VisibilityPackage.VISIBILITY_CLASS: {
				VisibilityClass visibilityClass = (VisibilityClass)theEObject;
				T result = caseVisibilityClass(visibilityClass);
	 ...
	 * @generated
	 */
	public T caseVisibilityClass(VisibilityClass object) {
		return null;
	}
