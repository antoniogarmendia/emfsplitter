...
public class VisibilityAdapterFactory extends AdapterFactoryImpl {
	...
	protected VisibilitySwitch<Adapter> modelSwitch =
		new VisibilitySwitch<Adapter>() {
			@Override
			public Adapter caseVisibilityClass(VisibilityClass object) {
				return createVisibilityClassAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Visibility.VisibilityClass <em>Class</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVisibilityClassAdapter() {
		return null;
	}
